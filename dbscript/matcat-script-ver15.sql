...
COMMENT ON COLUMN TBL_FILE_TYPE.FILE_TYPE IS '파일구분';

COMMENT ON COLUMN TBL_FILE_TYPE.FILE_TYPE_NAME IS '파일구분명';

COMMENT ON COLUMN TBL_FILE_TYPE.PRD_CODE IS '상품 코드';

COMMENT ON COLUMN TBL_FILE_TYPE.INQ_CODE IS '문의 코드';

COMMENT ON COLUMN TBL_FILE_TYPE.POST_CODE IS '게시글 코드';

COMMENT ON COLUMN TBL_FILE_TYPE.REV_CODE IS '리뷰코드';

COMMENT ON TABLE TBL_FILE_TYPE IS '첨부파일구분';
...
COMMENT ON COLUMN TBL_FILES.FILE_TYPE IS '파일구분';
