...
COMMENT ON COLUMN ORDER_STATUS.STATUS_CODE IS '상태코드';

COMMENT ON COLUMN ORDER_STATUS.STATUS_NAME IS '상태명';

COMMENT ON TABLE ORDER_STATUS IS '주문상태';
...
(
    ...
    AUTH_EXPLANATION    VARCHAR2(50) NOT NULL
);
...
(
  FILE_TYPE VARCHAR2(20) NOT NULL CONSTRAINT PK_FILE_TYPE PRIMARY KEY
, FILE_TYPE_NAME VARCHAR2(20) NOT NULL
);
COMMENT ON COLUMN TBL_FILE_TYPE.FILE_TYPE IS '파일 타입';

COMMENT ON COLUMN TBL_FILE_TYPE.FILE_TYPE_NAME IS '설명';
...
(
    FILE_IMG_CODE    NUMBER(20) NOT NULL CONSTRAINT PK_FILE_IMG_CODE PRIMARY KEY,
    FILE_PATH    VARCHAR2(1000) NOT NULL,
    FILE_SIZE    NUMBER(20) NOT NULL,
    FILE_UPLOAD_DATE    DATE NOT NULL,
    FILE_ORIGIN_NAME    VARCHAR2(300) NOT NULL,
    FILE_SAVED_NAME    VARCHAR2(300) NOT NULL,
...
ALTER TABLE TBL_FILES
ADD CONSTRAINT FK_REF_FILE_TYPE FOREIGN KEY ( FILE_TYPE )
REFERENCES TBL_FILE_TYPE ( FILE_TYPE );
...
COMMENT ON COLUMN TBL_FILES.FILE_TITLE_IMG_YN IS '대표이미지 여부';

COMMENT ON COLUMN TBL_FILES.FILE_TYPE IS '구분 코드';
...
(
  ...
  '진짜 맘처럼 안되네요',
  '진짜 와진짜맘처럼풀리는게하나도없어요진짜개힘들음진짜삼겹살개먹고싶습니다 아;',
  SYSDATE,
  10000,
  NULL,
  NULL
...
COMMENT ON COLUMN TBL_ORDER.ORDER_STATUS IS '주문상태';
...
(
    PRD_CODE    VARCHAR2(10) NOT NULL,
    PRD_NAME    VARCHAR2(500) NOT NULL,
...
COMMENT ON COLUMN TBL_REFUND.ORDER_STATUS IS '상태코드';
...
ALTER TABLE TBL_POST
 ADD CONSTRAINT FK_member_no123 FOREIGN KEY ( MEMBER_NO )
 REFERENCES TBL_MEMBER ( MEMBER_NO );
...
ALTER TABLE TBL_FILES
DISABLE CONSTRAINT FK_POST_CODE3;

ALTER TABLE TBL_FILES
DISABLE CONSTRAINT FK_INQ_CODE2;
...
(
    ...
    SEQ_ORD.NEXTVAL,
    TO_DATE('12-25-2018 11:11:11','MM-DD-YYYY HH24:MI:SS'),
    300,
    2,
    300,
    2
...
ALTER TABLE TBL_FILES
ENABLE CONSTRAINT FK_POST_CODE3;

ALTER TABLE TBL_FILES
ENABLE CONSTRAINT FK_INQ_CODE2;
