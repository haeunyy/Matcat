...
DROP SEQUENCE SEQ_FILE_CODE; -- 3/28 추가
...
create sequence seq_file_code nocycle nocache;
...
-- 3/23 PWD notNull 제거, ID 데이터 크기 조정,  
...
(
    ...
    MODY_DATE    DATE,
    DELETE_DATE    DATE,
    SELECT_TYPE  NUMBER(10) NOT NULL
);
...
COMMENT ON COLUMN TBL_POST.SELECT_TYPE IS '게시글 유형';
...
(
    ...
    PRD_QUAN    NUMBER(10) DEFAULT 100,
    CATEGORY_CODE    VARCHAR2(10) NOT NULL,
...
(
    ...
    CART_PRICE NUMBER(10) NOT NULL   -- 3/27 추가
);
...
COMMENT ON COLUMN TBL_CART.CART_PRICE IS '구매 금액';   -- 3/27 추가
...
(
    ...
    FILE_UPLOAD_DATE    DATE DEFAULT SYSDATE,  -- 3/28 기본값 누락돼서 추가함 
